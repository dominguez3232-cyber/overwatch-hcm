import svgPaths from "./svg-npgnx7y2y1";
...
function Container2() {
  return <div className="absolute bg-[rgba(255,255,255,0.1)] blur filter left-0 opacity-[0.619] rounded-[3.35544e+07px] size-[70px] top-0" data-name="Container" />;
}
...
function ImageErrorLoadingImage() {
  return (
    <div className="absolute left-[345.88px] size-[88px] top-[40px]" data-name="Image (Error loading image)">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src="50543c72ac282c7d1e87f38e3a21d381f32dd44f.png" />
    </div>
  );
}
...
function Badge29() {
  return (
    <div className="bg-[#fb2c36] h-[19.5px] opacity-[0.854] relative rounded-[6.75px] shrink-0 w-[36.375px]" data-name="Badge">
...
function Header() {
  return <div className="absolute bg-[#ff6467] left-[-5.08px] opacity-[0.508] rounded-[3.35544e+07px] size-[15.665px] top-[-5.08px]" data-name="Header" />;
}

function Badge45() {
  return (
    <div className="absolute bg-[#fb2c36] h-[23px] left-0 opacity-[0.977] rounded-[6.75px] top-[4.25px] w-[64.375px]" data-name="Badge">
