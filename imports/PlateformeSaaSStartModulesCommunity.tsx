import svgPaths from "./svg-rmrmhorsvv";
...
import imgPrimitiveImg from "figma:asset/07b022b30ff3bb35a2c58af8ead93f83abcb78b6.png";
...
function Container2() {
  return <div className="absolute bg-[rgba(255,255,255,0.1)] blur filter left-0 opacity-[0.506] rounded-[3.35544e+07px] size-[70px] top-0" data-name="Container" />;
}
...
function Paragraph22() {
  return (
    <div className="content-stretch flex h-[17.5px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="basis-0 font-['Arimo:Regular',_sans-serif] font-normal grow leading-[17.5px] min-h-px min-w-px relative shrink-0 text-[#99a1af] text-[12.25px]">Training Hub</p>
    </div>
  );
}
...
function Container157() {
  return (
    <div className="absolute content-stretch flex flex-col h-[42px] items-start left-[45.5px] top-0 w-[79.797px]" data-name="Container">
      <Heading1 />
      <Paragraph22 />
    </div>
  );
...
function Badge28() {
  return (
    <div className="bg-[#fb2c36] h-[19.5px] opacity-[0.506] relative rounded-[6.75px] shrink-0 w-[36.375px]" data-name="Badge">
...
function Icon69() {
  return (
    <div className="relative shrink-0 size-[17.5px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Icon">
          <path d={svgPaths.p16e2ef00} id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.45833" />
        </g>
      </svg>
    </div>
  );
...
function Heading26() {
  return (
    <div className="content-stretch flex h-[24.5px] items-start overflow-clip relative shrink-0 w-full" data-name="Heading 2">
      <p className="basis-0 font-['Arimo:Bold',_sans-serif] font-bold grow leading-[24.5px] min-h-px min-w-px relative shrink-0 text-[17.5px] text-white">Bonjour, Alex Johnson</p>
    </div>
  );
}
...
function Paragraph23() {
  return (
    <div className="h-[21px] overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[21px] left-0 text-[#99a1af] text-[14px] text-nowrap top-[-1px] whitespace-pre">5 modules débloqués sur 12</p>
    </div>
  );
}
...
function Header() {
  return <div className="absolute bg-[#ff6467] left-[-7.75px] opacity-0 rounded-[3.35544e+07px] size-[21px] top-[-7.75px]" data-name="Header" />;
}

function Badge43() {
  return (
    <div className="absolute bg-[#fb2c36] h-[23px] left-0 opacity-[0.506] rounded-[6.75px] top-[4.25px] w-[64.375px]" data-name="Badge">
...
function Text53() {
  return (
    <div className="h-[17.5px] relative shrink-0 w-[24.156px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[17.5px] relative w-[24.156px]">
        <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[17.5px] left-0 text-[12.25px] text-white top-[-2px] w-[25px]">42%</p>
      </div>
    </div>
  );
}
...
function PrimitiveDiv5() {
  return (
    <div className="bg-[#1e2939] box-border content-stretch flex flex-col h-[7px] items-start overflow-clip pr-[1850.2px] py-0 relative rounded-[3.35544e+07px] shrink-0 w-full" data-name="Primitive.div">
      <Container191 />
    </div>
  );
}
